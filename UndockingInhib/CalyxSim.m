function [cost, simTraces] = CalyxSim(x)
...
simTraces = nan(111, 24); %matrix holding traces from all sims
...
%put traces in matrix
simTraces(1:100,1) = hz_1_WT;
simTraces(:,2) = hz_10_WT;
simTraces(:,3) = hz_20_WT;
simTraces(:,4) = hz_50_WT;
simTraces(:,5) = hz_100_WT;
simTraces(:,6) = hz_200_WT;

simTraces(1:100,7) = hz_1_3KO;
simTraces(:,8) = hz_10_3KO;
simTraces(:,9) = hz_20_3KO;
simTraces(:,10) = hz_50_3KO;
simTraces(:,11) = hz_100_3KO;
simTraces(:,12) = hz_200_3KO;

simTraces(1:100,13) = hz_1_7KO;
simTraces(:,14) = hz_10_7KO;
simTraces(:,15) = hz_20_7KO;
simTraces(:,16) = hz_50_7KO;
simTraces(:,17) = hz_100_7KO;
simTraces(:,18) = hz_200_7KO;

simTraces(1:100,19) = hz_1_DKO;
simTraces(:,20) = hz_10_DKO;
simTraces(:,21) = hz_20_DKO;
simTraces(:,22) = hz_50_DKO;
simTraces(:,23) = hz_100_DKO;
simTraces(:,24) = hz_200_DKO;
