...
k_undocking_transient = .0005; %undocking rate in presence of Ca-bound syt3

k_docking = .0030; %amount by which docking is decreased in the presence of Ca-unbound syt3
k_undocking = .0005; %amount by which undocking is decreased in the presence of Ca-unbound syt3
...
function dydt = dSS(~,state,k_docking,k_undocking,k_docking_transient,k_undocking_transient,Ca_rest)
    ...
    dydt(1) = -state(1)*(k_docking_transient - k_docking*(1-state(3))) + state(2)*(k_undocking_transient - k_undocking*(1-state(3)));
    dydt(2) = state(1)*(k_docking_transient - k_docking*(1-state(3))) - state(2)*(k_undocking_transient - k_undocking*(1-state(3)));
