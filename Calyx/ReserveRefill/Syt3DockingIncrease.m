...
%x = [0.22194,0.00079166,2.9711e-05,11.2677,7.8138e-05,31.8109,5.0482]; %2/20/21 fit cost = 3.56945
x = [0.5,0.006,0.01,100,0,0,0];
...
if run_WT == 1
    ...
    [ts_1_WT, state_1_WT, Fused_1_WT] = stim_sim(stimulus_times_1, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
    hz_1_WT = Fused_1_WT/Fused_1_WT(1);

    [ts_10_WT, state_10_WT, Fused_10_WT] = stim_sim(stimulus_times_10, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
    hz_10_WT = Fused_10_WT/Fused_10_WT(1);

    [ts_20_WT, state_20_WT, Fused_20_WT] = stim_sim(stimulus_times_20, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
    hz_20_WT = Fused_20_WT/Fused_20_WT(1);

    [ts_50_WT, state_50_WT, Fused_50_WT] = stim_sim(stimulus_times_50, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
    hz_50_WT = Fused_50_WT/Fused_50_WT(1);

    [ts_100_WT, state_100_WT, Fused_100_WT] = stim_sim(stimulus_times_100, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
    hz_100_WT = Fused_100_WT/Fused_100_WT(1);

    [ts_200_WT, state_200_WT, Fused_200_WT] = stim_sim(stimulus_times_200, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
if run_3KO == 1
    ...
    [ts_1_3KO, state_1_3KO, Fused_1_3KO] = stim_sim(stimulus_times_1, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
    hz_1_3KO = Fused_1_3KO/Fused_1_3KO(1);

    [ts_10_3KO, state_10_3KO, Fused_10_3KO] = stim_sim(stimulus_times_10, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
    hz_10_3KO = Fused_10_3KO/Fused_10_3KO(1);

    [ts_20_3KO, state_20_3KO, Fused_20_3KO] = stim_sim(stimulus_times_20, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
    hz_20_3KO = Fused_20_3KO/Fused_20_3KO(1);

    [ts_50_3KO, state_50_3KO, Fused_50_3KO] = stim_sim(stimulus_times_50, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
    hz_50_3KO = Fused_50_3KO/Fused_50_3KO(1);

    [ts_100_3KO, state_100_3KO, Fused_100_3KO] = stim_sim(stimulus_times_100, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
    hz_100_3KO = Fused_100_3KO/Fused_100_3KO(1);

    [ts_200_3KO, state_200_3KO, Fused_200_3KO] = stim_sim(stimulus_times_200, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
if run_DKO == 1
    ...
    [ts_1_DKO, state_1_DKO, Fused_1_DKO] = stim_sim(stimulus_times_1, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
    hz_1_DKO = Fused_1_DKO/Fused_1_DKO(1);

%     [ts_10_DKO, state_10_DKO, Fused_10_DKO] = stim_sim(stimulus_times_10, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
%     hz_10_DKO = Fused_10_DKO/Fused_10_DKO(1);
% 
%     [ts_20_DKO, state_20_DKO, Fused_20_DKO] = stim_sim(stimulus_times_20, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
%     hz_20_DKO = Fused_20_DKO/Fused_20_DKO(1);
% 
%     [ts_50_DKO, state_50_DKO, Fused_50_DKO] = stim_sim(stimulus_times_50, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
%     hz_50_DKO = Fused_50_DKO/Fused_50_DKO(1);
% 
%     [ts_100_DKO, state_100_DKO, Fused_100_DKO] = stim_sim(stimulus_times_100, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
%     hz_100_DKO = Fused_100_DKO/Fused_100_DKO(1);

    [ts_200_DKO, state_200_DKO, Fused_200_DKO] = stim_sim(stimulus_times_200, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
if run_7KO == 1
    ...
    [ts_100_7KO, state_100_7KO, Fused_100_7KO] = stim_sim(stimulus_times_100, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
    hz_100_7KO = Fused_100_7KO/Fused_100_7KO(1);

    [ts_200_7KO, state_200_7KO, Fused_200_7KO] = stim_sim(stimulus_times_200, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
if run_WT == 1
    ...
    semilogx(rec,hz_10_WT(101:111),'o','color',[0, 0, 0]/255)
    semilogx(rec,hz_20_WT(101:111),'o','color',[255, 0, 0]/255)
    semilogx(rec,hz_50_WT(101:111),'o','color',[0, 0, 255]/255)
...
if run_3KO == 1
    ...
    semilogx(rec,hz_10_3KO(101:111),'o','color',[0, 0, 0]/255)
    semilogx(rec,hz_20_3KO(101:111),'o','color',[255, 0, 0]/255)
    semilogx(rec,hz_50_3KO(101:111),'o','color',[0, 0, 255]/255)
...
if run_7KO == 1
    ...
    semilogx(rec,hz_10_7KO(101:111),'o','color',[0, 0, 0]/255)
    semilogx(rec,hz_20_7KO(101:111),'o','color',[255, 0, 0]/255)
    semilogx(rec,hz_50_7KO(101:111),'o','color',[0, 0, 255]/255)
...
%     semilogx(rec,CalyxDataDKO(101:111,5),'-','color',[255, 128, 0]/255)
    ...
    set(gca,'xlim',[10 25000])
    set(gca,'ylim',[0 1.2])
%     semilogx(rec,hz_10_DKO(101:111),'o','color',[0, 0, 0]/255)
%     semilogx(rec,hz_20_DKO(101:111),'o','color',[255, 0, 0]/255)
%     semilogx(rec,hz_50_DKO(101:111),'o','color',[0, 0, 255]/255)
...
function [ts, state, Fused] = stim_sim(stimulus_times, p_release, k_docking, k_undocking, SS, reserve_size, k_refill, Syt3, Syt7)
