...
disp(['Testing x = [', num2str(x(1)), ',', num2str(x(2)), ',', num2str(x(3)), ',', num2str(x(4)), ',', num2str(x(5)), ',', num2str(x(6)), ',', num2str(x(7)), ',', num2str(x(8)), ']'])
...
[~, ~, Fused_1_WT] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
hz_1_WT = Fused_1_WT/Fused_1_WT(1);

[~, ~, Fused_10_WT] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
hz_10_WT = Fused_10_WT/Fused_10_WT(1);

[~, ~, Fused_20_WT] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
hz_20_WT = Fused_20_WT/Fused_20_WT(1);

[~, ~, Fused_50_WT] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
hz_50_WT = Fused_50_WT/Fused_50_WT(1);

[~, ~, Fused_100_WT] = stim_sim(stimulus_times_100, max_time_100, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
hz_100_WT = Fused_100_WT/Fused_100_WT(1);

[~, ~, Fused_200_WT] = stim_sim(stimulus_times_200, max_time_200, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
[~, ~, Fused_1_3KO] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
hz_1_3KO = Fused_1_3KO/Fused_1_3KO(1);

[~, ~, Fused_10_3KO] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
hz_10_3KO = Fused_10_3KO/Fused_10_3KO(1);

[~, ~, Fused_20_3KO] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
hz_20_3KO = Fused_20_3KO/Fused_20_3KO(1);

[~, ~, Fused_50_3KO] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
hz_50_3KO = Fused_50_3KO/Fused_50_3KO(1);

[~, ~, Fused_100_3KO] = stim_sim(stimulus_times_100, max_time_100, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
hz_100_3KO = Fused_100_3KO/Fused_100_3KO(1);

[~, ~, Fused_200_3KO] = stim_sim(stimulus_times_200, max_time_200, p_release, k_docking, k_undocking, SS_3KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
[~, ~, Fused_1_DKO] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
hz_1_DKO = Fused_1_DKO/Fused_1_DKO(1);

[~, ~, Fused_10_DKO] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
hz_10_DKO = Fused_10_DKO/Fused_10_DKO(1);

[~, ~, Fused_20_DKO] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
hz_20_DKO = Fused_20_DKO/Fused_20_DKO(1);

[~, ~, Fused_50_DKO] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
hz_50_DKO = Fused_50_DKO/Fused_50_DKO(1);

[~, ~, Fused_100_DKO] = stim_sim(stimulus_times_100, max_time_100, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
hz_100_DKO = Fused_100_DKO/Fused_100_DKO(1);

[~, ~, Fused_200_DKO] = stim_sim(stimulus_times_200, max_time_200, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
...
[~, ~, Fused_1_7KO] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
hz_1_7KO = Fused_1_7KO/Fused_1_7KO(1);

[~, ~, Fused_10_7KO] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
hz_10_7KO = Fused_10_7KO/Fused_10_7KO(1);

[~, ~, Fused_20_7KO] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
hz_20_7KO = Fused_20_7KO/Fused_20_7KO(1);

[~, ~, Fused_50_7KO] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
hz_50_7KO = Fused_50_7KO/Fused_50_7KO(1);

[~, ~, Fused_100_7KO] = stim_sim(stimulus_times_100, max_time_100, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
hz_100_7KO = Fused_100_7KO/Fused_100_7KO(1);

[~, ~, Fused_200_7KO] = stim_sim(stimulus_times_200, max_time_200, p_release, k_docking, k_undocking, SS_7KO, reserve_size, k_refill, Syt_pool_size, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
