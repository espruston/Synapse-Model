...
[~, ~, Fused_1_DKO] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx1HzSyt3, C_7*Calyx1HzSyt7);
hz_1_DKO = Fused_1_DKO/Fused_1_DKO(1);

[~, ~, Fused_10_DKO] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx10HzSyt3, C_7*Calyx10HzSyt7);
hz_10_DKO = Fused_10_DKO/Fused_10_DKO(1);

[~, ~, Fused_20_DKO] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx20HzSyt3, C_7*Calyx20HzSyt7);
hz_20_DKO = Fused_20_DKO/Fused_20_DKO(1);

[~, ~, Fused_50_DKO] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx50HzSyt3, C_7*Calyx50HzSyt7);
hz_50_DKO = Fused_50_DKO/Fused_50_DKO(1);

[~, ~, Fused_100_DKO] = stim_sim(stimulus_times_100, max_time_100, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx100HzSyt3, C_7*Calyx100HzSyt7);
hz_100_DKO = Fused_100_DKO/Fused_100_DKO(1);

[~, ~, Fused_200_DKO] = stim_sim(stimulus_times_200, max_time_200, p_release, k_docking, k_undocking, SS_DKO, reserve_size, k_refill, C_3*Calyx200HzSyt3, C_7*Calyx200HzSyt7);
