function [cost_value, num_ves_factor, peak1s_corrected, peak2s_extr_corrected, pprs_extr] = cost_model4_Qmax_kM_unprim_numves_primrate(pars, prim_coop, save_data)
...
disp(['prim_rate_const = ' num2str(prim_rate_const)])
...
%%%Write log file for each iteration
    ...
    fullfile = ['./Sim_data/Log_files/Log_Optimization_model4_Qmax_kM_unprim_numvesfactor_primrate_primcoop' num2str(Ca_prim_type)];
