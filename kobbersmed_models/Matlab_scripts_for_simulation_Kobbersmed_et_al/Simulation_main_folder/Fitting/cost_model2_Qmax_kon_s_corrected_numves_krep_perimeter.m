function [cost_value, num_ves_factor, peak1s_corrected, peak2s_extr_corrected, pprs_extr] = cost_model2_Qmax_kon_s_corrected_numves_krep_perimeter(pars, save_data, SS_coop)
...
%NOTE: This optimizes perimeter model (SVs at equal distances).
...
% 
% else
    fullfile = ['./Sim_data/Log_files/Log_Optimization_model2_SScoop' num2str(SS_coop) '_Qmax_kon_s_numvesfactor_krep_perimeter'];
% end
