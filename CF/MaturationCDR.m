%x = [0.57676,0.063374,0.0043336,0.0030516,0.004604,0.00118,3.8875]; %best fit 11/6/2020 (err=1.0739)
x = [0.72457,0.01246,0.0019237,0.0016432,0.0057323,0.0037772,9.2913]; %best fit 11/8/2020 (0.88316)
%x = [0.1,0.01246,0.0019237,0.0016432,0.0057323,0.0037772,9.2913];
...
[~,state] = ode113(@(t,state) dSS(t,state,k_docking*(1+CF1HzSyt3(1)*C_3),k_undocking,k_maturation,k_dematuration), [0 t_SS], state_0);
