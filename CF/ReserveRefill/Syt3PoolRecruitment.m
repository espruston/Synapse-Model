...
x = [0.66322,0.003346,0.00072235,8.687,5.9651e-05,0.063422,49.9845]; %best fit 2/15/21 cost=1.1365
...
%WT
[t0,state] = ode113(@(t,state) dSS(t, state, k_docking, k_undocking, reserve_size, k_refill, Syt_pool_size, C_3*CF1HzSyt3(1)), [0 t_SS], state_0);

SS_WT = state(end,:);

[ts_1_WT, state_1_WT, Fused_1_WT] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*CF1HzSyt3);
hz_1_WT = Fused_1_WT/Fused_1_WT(1);

[ts_10_WT, state_10_WT, Fused_10_WT] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*CF10HzSyt3);
hz_10_WT = Fused_10_WT/Fused_10_WT(1);

[ts_20_WT, state_20_WT, Fused_20_WT] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*CF20HzSyt3);
hz_20_WT = Fused_20_WT/Fused_20_WT(1);

[ts_50_WT, state_50_WT, Fused_50_WT] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_WT, reserve_size, k_refill, Syt_pool_size, C_3*CF50HzSyt3);
...
[ts_1_KO, state_1_KO, Fused_1_KO] = stim_sim(stimulus_times_1, max_time_1, p_release, k_docking, k_undocking, SS_KO, reserve_size, k_refill, Syt_pool_size, C_3*CF1HzSyt3);
hz_1_KO = Fused_1_KO/Fused_1_KO(1);

[ts_10_KO, state_10_KO, Fused_10_KO] = stim_sim(stimulus_times_10, max_time_10, p_release, k_docking, k_undocking, SS_KO, reserve_size, k_refill, Syt_pool_size, C_3*CF10HzSyt3);
hz_10_KO = Fused_10_KO/Fused_10_KO(1);

[ts_20_KO, state_20_KO, Fused_20_KO] = stim_sim(stimulus_times_20, max_time_20, p_release, k_docking, k_undocking, SS_KO, reserve_size, k_refill, Syt_pool_size, C_3*CF20HzSyt3);
hz_20_KO = Fused_20_KO/Fused_20_KO(1);

[ts_50_KO, state_50_KO, Fused_50_KO] = stim_sim(stimulus_times_50, max_time_50, p_release, k_docking, k_undocking, SS_KO, reserve_size, k_refill, Syt_pool_size, C_3*CF50HzSyt3);
...
plot(ts_1_WT,state_1_WT(:,3),'--r')
plot(ts_1_WT,state_1_WT(:,4),'--b')
plot(ts_1_WT,state_1_WT(:,5),'-k')
...
plot(ts_10_WT,state_10_WT(:,3),'--r')
plot(ts_10_WT,state_10_WT(:,4),'--b')
plot(ts_10_WT,state_10_WT(:,5),'-k')
...
plot(ts_20_WT,state_20_WT(:,3),'--r')
plot(ts_20_WT,state_20_WT(:,4),'--b')
plot(ts_20_WT,state_20_WT(:,5),'-k')
...
plot(ts_50_WT,state_50_WT(:,3),'--r')
plot(ts_50_WT,state_50_WT(:,4),'--b')
plot(ts_50_WT,state_50_WT(:,5),'-k')
...
plot(ts_1_KO,state_1_KO(:,3),'--r')
plot(ts_1_KO,state_1_KO(:,4),'--b')
plot(ts_1_KO,state_1_KO(:,5),'-k')

ax = gca;
ax.XRuler.Exponent = 0;

legend({'Empty Sites','Filled Sites','Empty Syt3 Sites','Filled Syt3 Sites','Reserve Vesicles'},'Location','Best')
...
plot(ts_10_KO,state_10_KO(:,3),'--r')
plot(ts_10_KO,state_10_KO(:,4),'--b')
plot(ts_10_KO,state_10_KO(:,5),'-k')
...
plot(ts_20_KO,state_20_KO(:,3),'--r')
plot(ts_20_KO,state_20_KO(:,4),'--b')
plot(ts_20_KO,state_20_KO(:,5),'-k')
...
plot(ts_50_KO,state_50_KO(:,3),'--r')
plot(ts_50_KO,state_50_KO(:,4),'--b')
plot(ts_50_KO,state_50_KO(:,5),'-k')
...
function [ts, state, Fused] = stim_sim(stimulus_times, max_time, p_release, k_docking, k_undocking, SS, reserve_size, k_refill, Syt_pool_size, Syt3)
    ...
    if stimulus_times == linspace(0,20*19,20) %50hz
        ...
        for i = 1:length(Recovery)
            ...
            [t,out] = ode113(@(t,state) dState(t, state, k_docking, k_undocking, reserve_size, k_refill, Syt_pool_size, Syt3(i,:)), stimulus_times(end)+[0 Recovery(i)], post_stim);
            pre_stim = out(end,:);
