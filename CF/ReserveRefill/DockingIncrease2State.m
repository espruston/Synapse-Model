...
x = [0.000267563,0.698463,0.00605823,0.0731115,0.0250303,0.00192173,11.5335,9.39172e-05,49.9979]; %cost = 0.80328 on 2/28
...
[ts_1_WT, state_1_WT, Fused_1_WT] = stim_sim(stimulus_times_1, max_time_1, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_WT, reserve_size, k_refill, C_3*CF1HzSyt3);
hz_1_WT = Fused_1_WT/Fused_1_WT(1);

[ts_10_WT, state_10_WT, Fused_10_WT] = stim_sim(stimulus_times_10, max_time_10, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_WT, reserve_size, k_refill, C_3*CF10HzSyt3);
hz_10_WT = Fused_10_WT/Fused_10_WT(1);

[ts_20_WT, state_20_WT, Fused_20_WT] = stim_sim(stimulus_times_20, max_time_20, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_WT, reserve_size, k_refill, C_3*CF20HzSyt3);
hz_20_WT = Fused_20_WT/Fused_20_WT(1);

[ts_50_WT, state_50_WT, Fused_50_WT] = stim_sim(stimulus_times_50, max_time_50, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_WT, reserve_size, k_refill, C_3*CF50HzSyt3);
...
%KO
C_3 = 0;
[t0,state] = ode113(@(t,state) dSS(t, state, k_docking, k_undocking, k_tether, k_untether, reserve_size, k_refill, C_3*CF1HzSyt3(1)), [0 t_SS], state_0);

SS_KO = state(end,:);

[ts_1_KO, state_1_KO, Fused_1_KO] = stim_sim(stimulus_times_1, max_time_1, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_KO, reserve_size, k_refill, C_3*CF1HzSyt3);
hz_1_KO = Fused_1_KO/Fused_1_KO(1);

[ts_10_KO, state_10_KO, Fused_10_KO] = stim_sim(stimulus_times_10, max_time_10, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_KO, reserve_size, k_refill, C_3*CF10HzSyt3);
hz_10_KO = Fused_10_KO/Fused_10_KO(1);

[ts_20_KO, state_20_KO, Fused_20_KO] = stim_sim(stimulus_times_20, max_time_20, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_KO, reserve_size, k_refill, C_3*CF20HzSyt3);
hz_20_KO = Fused_20_KO/Fused_20_KO(1);

[ts_50_KO, state_50_KO, Fused_50_KO] = stim_sim(stimulus_times_50, max_time_50, p_release_dock, p_release_tether, k_docking, k_undocking, k_tether, k_untether, SS_KO, reserve_size, k_refill, C_3*CF50HzSyt3);
