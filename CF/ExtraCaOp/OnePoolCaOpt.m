x0 = [0.85,0.001,0.0001,50,7e6,10]; %[p_release, k_docking, k_undocking,reserve_size, C_Ca]
lb = [.5, 0.0001, 0.0001, 1, 1e6, 1];
ub = [1, 0.01, 0.01, 100, 1e7, 10];
A = [];
b = [];
...
problem = createOptimProblem('fmincon','objective',@OnePoolCaFunc,'x0',x0,'lb',lb,'ub',ub,'Aineq',A,'bineq',b);
