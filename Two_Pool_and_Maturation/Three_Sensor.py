...
class Skyler_dual_sensor(object):
    ...
    def __init__(self, K_D_1, K_D_7, k_on_1, k_on_7, k_off_1, k_off_7, Ca_rest, Ca_residual, T_Ca_decay, Ca_spike, FWHM, delta_t, max_time, stimulus_times):
        ...
        for i in range(len(ts)):
            ...
            membrane_bound_syt1.append(membrane_bound_syt1[-1] + (1 - membrane_bound_syt1[-1])*k_on_1*Ca_bound_syt1[-1]*delta_t - membrane_bound_syt1[-1]*k_off_1*delta_t)#increases according to free_syt1*k_on*Ca_bound, decreases according to bound*k_off over delta_t
            membrane_bound_syt7.append(membrane_bound_syt7[-1] + (1 - membrane_bound_syt7[-1])*k_on_7*Ca_bound_syt7[-1]*delta_t - membrane_bound_syt7[-1]*k_off_7*delta_t)
