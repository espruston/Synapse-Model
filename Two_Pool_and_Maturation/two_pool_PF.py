...
if __name__ == "__main__":
    ...
    axdelta_F= plt.axes([0.25, 0.15, 0.65, 0.01], facecolor=axcolor)
    ...
    sdelta_F = Slider(axdelta_F, 'delta_F', 0.01, 100, valinit=delta_F, valstep=0.01)
    ...
    def update(val):
        ...
        EPSC_2 = two_pool(2, n_pulses, size_fast, size_slow, p_fast, p_slow, T_fast, T_slow, delta_F, T_F).EPSC
        ...
        EPSC_100 = two_pool(100, n_pulses, size_fast, size_slow, p_fast, p_slow, T_fast, T_slow, delta_F, T_F).EPSC
        ...
        avg_r_squared = (r_squared_1hz + r_squared_1hz+ r_squared_10hz + r_squared_20hz + r_squared_50hz + r_squared_100hz)/6
